...
date ; ./single_init.csh Dockerfile     wrf_regtest    > output_s_14 ; date 
./test_014s.csh > outs & 

wait 
./single_end.csh wrf_regtest    >> output_s_14 ; date 
cat SERIAL outs >> output_s_14
date ; ./last_only_once.csh >> output_s_14 ; date
rm outs 
