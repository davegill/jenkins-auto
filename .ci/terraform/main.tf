...
# }
variable "hostnames" {
   default = ["wrf_testcases_1.sh", "wrf_testcases_3.sh","wrf_testcases_4.sh","wrf_testcases_5.sh","wrf_testcases_6.sh","wrf_testcases_7.sh", "wrf_testcases_9.sh","wrf_testcases_10.sh","wrf_testcases_11.sh","wrf_testcases_12.sh","wrf_testcases_13.sh","wrf_testcases_14.sh","wrf_testcases_15.sh","wrf_testcases_16.sh","wrf_testcases_17.sh","wrf_testcases_18.sh","wrf_testcases_19.sh"]
}
