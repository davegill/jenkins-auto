...
# variable "hostnames"{
#    default = ["wrf_testcase_57.sh","wrf_testcase_58.sh","wrf_testcase_59.sh","wrf_testcase_60.sh"]
# }
...
#   instance_type                 = "${var.instance_type_1}"
  instance_type                 = "${count.index >= 2 && count.index <= 5 && count.index >= 42 && count.index <= 46 ? var.instance_type_1 : var.instance_type}"
