...
cd wrf-stuff/
git clone --branch leave_docker_images git@github.com:scala-computing/wrf-coop.git
cd wrf-coop/
...
cat SERIAL outs OPENMP outo MPI outm >> output_15
date ; ./last_only_once.csh >> output_15 ; date
rm outs outo outm 
